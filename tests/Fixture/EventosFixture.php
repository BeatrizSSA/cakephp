...
class EventosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'eventname' => ['type' => 'string', 'length' => 50, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'eventos_ibfk_1' => ['type' => 'foreign', 'columns' => ['users_id'], 'references' => ['users', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'data' => '2018-03-16 16:18:36',
            'role' => 'Lorem ipsum dolor ',
            'created' => '2018-03-16 16:18:36',
            'modified' => '2018-03-16 16:18:36',
            'users_id' => 1
        ],
    ];
}
